...
//9613826e4c448e1af68147c73890f39b
...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchWeatherData(cityName: String) {
        ...
        val response = retrofit.getWeatherData(cityName,"9613826e4c448e1af68147c73890f39b","metric")
...
//                    Log.d("TAG", "onResponse: $temperature")
    ...
    private fun changeImagesAccordingToWeatherConditions(conditions:String) {
        when(conditions){
            ...
            "PartlyCloud","Cloud","Overcast","Mist","Foggy"->{
